                            ...
                            <div class="row">
                              <div class="col-sm-12">
                                <div class="sender-account-box">
                                  ...
                                  <form name="frmAddSMTP" method="POST" action="{{ route('update-template',['id'=>$template->id]) }}" enctype="multipart/form-data">
                                    @method('PUT')
                                    @csrf
                                    <div class="row">
                                      <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <textarea name="template_body" id="template_body">{{ $template->template_body }}</textarea>
                                          @error('template_body')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                          @enderror
                                        </div>

                            ...
                            <div class="row">
                              <div class="col-sm-12">
                                <div class="sender-account-box">
                                  ...
                                  <form name="frmAddSMTP" method="POST" action="{{ route('save-smtp') }}">
                                    @csrf
                                    <div class="row">
                                      <div class="col-sm-12">
                                    ...
                                    <button type="submit" class="btn btn-success" id="btnSaveSmtp" disabled>Save</button>
                                  </form>
                                </div>
